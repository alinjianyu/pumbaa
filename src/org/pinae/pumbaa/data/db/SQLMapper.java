...
public class SQLMapper {
	 ...
	 * @return 映射后的List<Map>
	 */
	public List<Map<String, Object>> convertTableToMapList(List<Object[]> table, String[] columns) {
	 ...
	 * @return 映射后的List<Map>
	 */
	public List<Map<String, Object>> convertTableToMapList(List<Object[]> table, String[] columns, Map<String, Object> defaultMap) {
		List<Map<String, Object>> resultList = convertTableToMapList(table, columns);
	...
	public List<?> convertTableToObjectList(Class clazz, List<Object[]> table, String[] columns) {
